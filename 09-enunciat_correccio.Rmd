...
Finalment, recorda que el termini per realitzar la correcció és el dia 7 de maig.
...
url_treball = sprintf("https://moodle2.udg.edu/pluginfile.php/%d/mod_folder/content/0/treball_%s.pdf", ID_COURSE, id_tr)
url_formulari = link_form(id, id_tr)
url_enunciat = sprintf("https://moodle2.udg.edu/pluginfile.php/%d/mod_folder/content/0/enunciat1_%s.pdf", ID_COURSE, id_tr)
url_solucio = sprintf("https://moodle2.udg.edu/pluginfile.php/%d/mod_folder/content/0/solucio1_%s.pdf", ID_COURSE, id_tr)
```
