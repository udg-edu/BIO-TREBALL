...
<p style="color:blue;">__Objectiu d'aquest apartat__: a partir de la variable `difference`, mesurar la plausibilitat de la hipotesis o bé a través d'una contrast d'hipotesis o bé a través d'un interval de confiança.</p>
