...
unzip("3103G000842021 Estadística aplicada-TREBALL 2n lliurament-1168815.zip", exdir = 'treballs')
treballs = tibble(
...
with(treballs_entregats, walk2(id_group, fitxer, function(id, fname){
  file.copy(fname, sprintf("06B-treballs/treball_2_%d.pdf", id))
}))
...
writeLines(sprintf("%s", paste(c('2002963',unique(treballs_entregats$id_group)), collapse = ' ')), con = 'codis_treballs_B.txt')

rmarkdown::render("06B-treballs.Rmd", output_file = "docs/2021/treballsB.html")
